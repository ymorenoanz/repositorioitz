...
const headCells = [
  ...
  { id: 'tipoarchivo', numeric: true, disablePadding: false, label: 'Tipo de archivo' },
  { id: 'tamanoarchivo', numeric: true, disablePadding: false, label: 'Tamaño' },
  { id: 'categoria', numeric: true, disablePadding: false, label: 'Categoria' },
  { id: 'rutadocumento', numeric: true, disablePadding: false, label: 'Descargar' },
];
...
export default function DownloadFiles() 
{
  ...
  const handleSelectAllClick = (event) => 
  {
    if (event.target.checked) {
      const newSelecteds = notas.map((n) => n.name);
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={notas.length}
            />
            <TableBody>
              {stableSort(notas, getComparator(order, orderBy))
                .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                .map((note, index) => {
                  const isItemSelected = isSelected(note.id);
